                                                                          ...
                                                                          if (_value != 10 ||
                                                                            ...
                                                                            setState(() {
                                                                              AppConstants.basket_return.add({
                                                                                'product': products[i],
                                                                                'count': double.parse(productsTextFieldControllers[i].text),
                                                                                'type': 1,
                                                                                'causeId': _value,
                                                                                'causeComment': commentController.text,
                                                                              });
                                                                              AppConstants.basketIDs_return.add(products[i]['id']);
                                                                            });
                                                                            ...
                                                                            Navigator.pop(context);
                                                                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                                                              content: Text("Возврат добавлен в корзину.", style: TextStyle(fontSize: 20)),
                                                                            ));
                                                                          } else {
                                                                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                                                              content: Text("Напишите причину.", style: TextStyle(fontSize: 20)),
                                                                            ));
                                                                          }
                                                                        },
                                                                      ),
                                                        ...
                                                        setState(() {
                                                          if (double.parse(
                                                            ...
                                                            productsTextFieldControllers[
                                                                        i]
                                                                    .text =
                                                                (double.parse(productsTextFieldControllers[i]
                                                                            .text) -
                                                                        1)
                                                                    .toString();
                                                          }
