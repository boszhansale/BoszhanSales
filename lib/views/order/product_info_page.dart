                              ...
                              children: [
                                widget.discount != 0
                                    ? Padding(
                                        ...
                                        child: Text(
                                          "${thisProduct['prices'][widget.priceTypeId - 1]['price']} тг/шт",
                                          style: TextStyle(
                                            fontSize: 16,
                                            fontWeight: FontWeight.bold,
                                            decoration:
                                ...
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 20, vertical: 10),
                                  child: Text(
                                    "${thisProduct['prices'].where((e) => e['price_type_id'] == widget.priceTypeId).toList()[0]['price'] * (100 - widget.discount) / 100} тг/шт",
                                    style: TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.bold,
                                    ),
