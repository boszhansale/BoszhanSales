...
import 'package:boszhan_sales/views/history_orders/history_legal_stores_page.dart';
import 'package:boszhan_sales/views/history_orders/history_legal_stores_page.dart';
import 'package:boszhan_sales/views/history_orders/history_legal_stores_page.dart';
import 'package:boszhan_sales/views/history_orders/history_legal_stores_page.dart';
import 'package:boszhan_sales/views/history_orders/history_legal_stores_page.dart';
...
class HistoryStoresPage extends StatefulWidget {
  @override
  _HistoryStoresPageState createState() => _HistoryStoresPageState();
}

class _HistoryStoresPageState extends State<HistoryStoresPage> {
